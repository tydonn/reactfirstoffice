...
export default function CityCard({ city }: CityCardProps) {
  console.log("City Data:", city); // Debugging untuk melihat data yang didapat dari database
  const baseURL = "http://127.0.0.1:8000/storage" //URL photo
  return (
    <div className="card">
