...
export default function BookOffice() {
        ...
        axios
            ...
            .catch((error: unknown) => {
                ...
                if (axios.isAxiosError(error)) {
                    console.error("Error fetching ofice data: ", error.message);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            //Handle succes (e.g., show a succes message or redirect)

            //Redirect to the succes page with the ofice the office and booking detail
            ...
            if (axios.isAxiosError(error)) {
                ...
                console.error("Unexpected error:", error);
                setError("An enexpected error ocurred");
            }
        } finally {
            setIsLoading(false);
        }
                ...
                <div className="flex flex-col shrink-0 w-[400px] h-fit rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="flex items-center justify-between">
                            ...
                            <p className="font-bold">{office.duration}</p>
                        </div>
                        <div className="flex items-center justify-between">
