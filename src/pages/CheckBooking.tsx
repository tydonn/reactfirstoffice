...
export default function CheckBooking() {
    ...
    useEffect(() => {
        if (bookingDetails && bookingDetails.office) {
            console.log(bookingDetails.office.thumbnail);
            console.log(bookingDetails.office.name);
            console.log(bookingDetails.office.city);
        } else {
            console.log("Data office tidak ada");
        }
    }, [bookingDetails]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        console.log("Validating for data...");
        ...
        try {
            ...
            console.log("We are checking booking: ", response.data.data);
            ...
            >
                ...
                >
                    <div className="flex flex-col w-full gap-2">
                        ...
                        {formErrors
                            .filter((error) => error.path.includes("booking_trx_id"))
                            .map((error) => (
                    ...
                    <div className="flex flex-col w-full gap-2">
                        ...
                        {formErrors
                            .filter((error) => error.path.includes("phone_number"))
                            .map((error) => (
                                <p key={error.message} className="text-red-500">{error.message}</p>
                            ))}
                    </div>
